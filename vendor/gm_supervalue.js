export const GM_SuperValue = new (function () {
  ...
  */
    this.set = function (varName, varValue) {
        ...
        if (/[^\w _-]/.test(varName)) {
            ReportError(
                "Suspect, probably illegal, varName sent to GM_SuperValue.set()."
            );
        }
  ...
  */
    this.get = function (varName, defaultValue) {
        ...
        if (/[^\w _-]/.test(varName)) {
            ReportError(
                "Suspect, probably illegal, varName sent to GM_SuperValue.get()."
            );
        }
    ...
    this.runTestCases = function (bUseConsole) {
        if (bUseConsole) {
            ...
            GM_getValue = function (varName, defaultValue) {
                ...
                if (!varValue) varValue = defaultValue;
